...
class TestCommand:
    ...
    def test_no_cache(self, session, command, which, expected):
        # type: (Streamlink, Optional[str], Dict, Optional[str])
    ...
    def test_is_usable(self, session, resolved, expected):
        # type: (Streamlink, Optional[str], bool)
...
class TestOpen:
    ...
    def test_ffmpeg_args(
        self,
        session,     # type: Streamlink
        popen,       # type: Mock
        devnull,     # type: Mock
        options,     # type: Dict
        muxer_args,  # type: Dict
        expected,    # type: List
    ):
    ...
    def test_stderr(self, session, popen):
        # type: (Streamlink, Mock)
